...
export class ChildServiceProxy {
    ...
    getChildren(): Observable<ChildDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Child/GetChildren";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_ : any) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<ChildDto[]>><any>Observable.throw(e);
                }
            } else
                return <Observable<ChildDto[]>><any>Observable.throw(response_);
        });
    }

    protected processGetChildren(response: Response): Observable<ChildDto[]> {
        const status = response.status; 
        ...
        return Observable.of<ChildDto[]>(<any>null);
    }
}
